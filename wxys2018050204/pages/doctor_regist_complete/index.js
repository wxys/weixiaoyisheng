// pages/doctor_regist_complete/index.js
//获取全局的应用实例
var app = getApp();
//引用公共文件
...
Page({
  ...
  UserLogin:function(){
    ...
    if (!data.doctor_name){
      ...
      return;
    } else if(!common.isChinese(data.doctor_name)){
      this.ShowRemind("请输入中文姓名");
      this.setData({
        BtnDisabled: false,
      })
      return;
      ...
      //资料保存
      wx.request({
        url: 'https://f.12590.com/SlowDiseaseTreasure/interface3.php?action=DoctorUserRegister2',
        data: ajax_data,
        method: 'GET',
        // header: {}, // 设置请求的 header
        success: function (res) {
          console.log(res);
          if (res.data.errcode == "400010") {
            UserData.doctor_name = data.doctor_name,
              setTimeout(function () {
